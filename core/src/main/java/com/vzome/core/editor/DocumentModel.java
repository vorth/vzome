...
public class DocumentModel implements Snapshot .Recorder, UndoableEdit .Context
{
    ...
    public DocumentModel( final FieldApplication kind, Command.FailureChannel failures, Element xml, final Application app )
    {
        ...
        this .mXML = xml;
        this .sceneLighting = new SceneLighting( app .getSceneLighting() );
        if ( xml != null ) {
    ...
    public Exporter3d getNaiveExporter( String format, Camera camera, Colors colors, SceneLighting lights, RenderedModel currentSnapshot )
    {
    ...
    public Exporter3d getStructuredExporter( String format, Camera camera, Colors colors, SceneLighting lights, RenderedModel mRenderedModel )
    {
    ...
    public Java2dSnapshot capture2d( RenderedModel model, int height, int width, Camera camera, SceneLighting lights,
