...
declare namespace java.util {
    ...
    interface Iterator<E> {
        hasNext(): boolean;
        next(): E;
        // vZome edit: optional, same reason as Iterable.forEach above.
...
declare namespace java.lang {
    ...
    interface Iterable<T> {
        iterator(): java.util.Iterator<T>;
        // vZome edit: optional. JSweet never emits forEach, so requiring it makes every
        // `implements Iterable` class fail (11 errors). Re-apply if j4ts.d.ts is refreshed.
        forEach?(action: (p1: any) => void): any;
    }
}
declare namespace java.lang {
