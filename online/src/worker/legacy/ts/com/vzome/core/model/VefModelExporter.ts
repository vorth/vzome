...
export class VefModelExporter extends VefVectorExporter implements Exporter {
    public constructor(writer: java.io.Writer, field: AlgebraicField, scale: AlgebraicNumber = null, withOffset: boolean = false) {
     ...
     * @param {*} man
     */
    public exportManifestation(man: Manifestation) {
     ...
     * @param {*} man
     */
    public exportSelectedManifestation(man: Manifestation) {
        if (man == null){
            this.output.println$();
            this.output.flush();
