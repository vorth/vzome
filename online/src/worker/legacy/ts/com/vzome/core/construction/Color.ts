...
export class Color {
    ...
    public equals(other: any): boolean {
        ...
        if (!(other != null && other instanceof <any>Color))return false;
     ...
     * @return {Color} The original color maximized then having each component
    ...
    /**
     * @param {Color} color
     * @return {Color} A new color where each of the RGB components are proportional to the parameter
