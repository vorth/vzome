...
export class SnubDodecField extends AbstractAlgebraicField {
    ...
    public constructor(factory: AlgebraicNumberFactory) {
     ...
     * @return {BigRational[]}
     */
    public multiply(a: BigRational[], b: BigRational[]): BigRational[] {
        const result: BigRational[] = (s => { let a=[]; while(s-->0) a.push(null); return a; })(this.getOrder());
        let factor: BigRational = a[SnubDodecField.A].times(b[SnubDodecField.A]);
