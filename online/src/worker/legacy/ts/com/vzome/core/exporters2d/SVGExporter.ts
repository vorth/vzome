 ...
 * @author scottv
 * @class
 * @extends SnapshotExporter
 */
export class SVGExporter extends SnapshotExporter {
    /**
     * 
     * @param {Color} bgColor
     */
    ...
    /**
     * 
     * @param {Java2dSnapshot.LineSegment} line
    ...
    outputLine(line: Java2dSnapshot.LineSegment, monochrome: boolean) {
        ...
        if (monochrome)color = Color.BLACK_$LI$().getRGB() & 16777215;
    ...
    /**
     * 
     * @param {Java2dSnapshot.Polygon} polygon
