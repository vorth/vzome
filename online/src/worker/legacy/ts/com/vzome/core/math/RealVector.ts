...
export class RealVector {
    ...
    static FORMAT: NumberFormat; public static FORMAT_$LI$(): NumberFormat { RealVector.__static_initialize(); if (RealVector.FORMAT == null) { RealVector.FORMAT = NumberFormat.getNumberInstance(java.util.Locale.US); }  return RealVector.FORMAT; }
    ...
    public constructor(x?: any, y?: any, z?: any) {
        ...
        } else if (((x != null && x instanceof <any>RealVector) || x === null) && y === undefined && z === undefined) {
            let __args = arguments;
    ...
    public toString$java_text_NumberFormat(format: NumberFormat): string {
    ...
    public toString(format?: any): string {
        if (((format != null && format instanceof <any>NumberFormat) || format === null)) {
    ...
    public write(buf: FloatBuffer, offset: number) {
    ...
    public equals(other: any): boolean {
        ...
        if (!(other != null && other instanceof <any>RealVector))return false;
