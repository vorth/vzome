...
export class Face {
    ...
    /*private*/ centroid: AlgebraicVector;

    planeOffset: AlgebraicNumber;
    ...
    public computeCentroid(): AlgebraicVector {
        const vectors: java.util.Set<AlgebraicVector> = <any>(new java.util.HashSet<any>());
        let he: HalfEdge = this.he0;
        do {{
            vectors.add(he.head().pnt);
            he = he.next;
        }} while((he !== this.he0));
        this.centroid = AlgebraicVectors.calculateCentroid(vectors);
        return this.centroid;
    }

    public computeNormal(): AlgebraicVector {
        let he1: HalfEdge = this.he0.next;
        let he2: HalfEdge = he1.next;
        const p0: AlgebraicVector = this.he0.head().pnt;
        let p2: AlgebraicVector = he1.head().pnt;
        let d2: AlgebraicVector = p2.minus(p0);
        this.normal = p0.getField().origin(3);
        this.numVerts = 2;
        while((he2 !== this.he0)) {{
            const d1: AlgebraicVector = d2;
            p2 = he2.head().pnt;
            d2 = p2.minus(p0);
    ...
    public static createTriangle$com_vzome_core_math_convexhull_Vertex$com_vzome_core_math_convexhull_Vertex$com_vzome_core_math_convexhull_Vertex(v0: Vertex, v1: Vertex, v2: Vertex): Face {
    ...
    public static createTriangle$com_vzome_core_math_convexhull_Vertex$com_vzome_core_math_convexhull_Vertex$com_vzome_core_math_convexhull_Vertex$double(v0: Vertex, v1: Vertex, v2: Vertex, minArea: number): Face {
        const face: Face = new Face();
        const he0: HalfEdge = new HalfEdge(v0, face);
        const he1: HalfEdge = new HalfEdge(v1, face);
        const he2: HalfEdge = new HalfEdge(v2, face);
        he0.prev = he2;
        he0.next = he1;
        he1.prev = he0;
        he1.next = he2;
    ...
    public static createTriangle(v0?: any, v1?: any, v2?: any, minArea?: any): Face {
        if (((v0 != null && v0 instanceof <any>Vertex) || v0 === null) && ((v1 != null && v1 instanceof <any>Vertex) || v1 === null) && ((v2 != null && v2 instanceof <any>Vertex) || v2 === null) && ((typeof minArea === 'number') || minArea === null)) {
            return <any>Face.createTriangle$com_vzome_core_math_convexhull_Vertex$com_vzome_core_math_convexhull_Vertex$com_vzome_core_math_convexhull_Vertex$double(v0, v1, v2, minArea);
        } else if (((v0 != null && v0 instanceof <any>Vertex) || v0 === null) && ((v1 != null && v1 instanceof <any>Vertex) || v1 === null) && ((v2 != null && v2 instanceof <any>Vertex) || v2 === null) && minArea === undefined) {
            return <any>Face.createTriangle$com_vzome_core_math_convexhull_Vertex$com_vzome_core_math_convexhull_Vertex$com_vzome_core_math_convexhull_Vertex(v0, v1, v2);
        } else throw new Error('invalid overload');
    }

    public static create(vtxArray: Vertex[], indices: number[]): Face {
        const face: Face = new Face();
        let hePrev: HalfEdge = null;
        for(let i: number = 0; i < indices.length; i++) {{
            const he: HalfEdge = new HalfEdge(vtxArray[indices[i]], face);
            if (hePrev != null){
                he.setPrev(hePrev);
                hePrev.setNext(he);
            } else {
     ...
     * @return {HalfEdge} the half-edge
     */
    public getEdge(i: number): HalfEdge {
        let he: HalfEdge = this.he0;
        while((i > 0)) {{
            he = he.next;
            i--;
     ...
     * @param {Vertex} vh
     * head point
     * @return {HalfEdge} the half-edge, or null if none is found.
     */
    public findEdge(vt: Vertex, vh: Vertex): HalfEdge {
        let he: HalfEdge = this.he0;
        do {{
     ...
     * 
     * @param {AlgebraicVector} p
     * the point
     * @return {*} distance from the point to the plane
     */
    public distanceToPlane(p: AlgebraicVector): AlgebraicNumber {
     ...
     * 
     * @return {AlgebraicVector} the planar normal
     */
    ...
    /*private*/ connectHalfEdges(hedgePrev: HalfEdge, hedge: HalfEdge): Face {
        let discardedFace: Face = null;
        if (hedgePrev.oppositeFace() === hedge.oppositeFace()){
            const oppFace: Face = hedge.oppositeFace();
            let hedgeOpp: HalfEdge;
    ...
    checkConsistency() {
        ...
        do {{
            const hedgeOpp: HalfEdge = hedge.getOpposite();
            if (hedgeOpp == null){
    ...
    public mergeAdjacentFace(hedgeAdj: HalfEdge, discarded: Face[]): number {
        const oppFace: Face = hedgeAdj.oppositeFace();
        let numDiscarded: number = 0;
        discarded[numDiscarded++] = oppFace;
        oppFace.mark = Face.DELETED;
        const hedgeOpp: HalfEdge = hedgeAdj.getOpposite();
        let hedgeAdjPrev: HalfEdge = hedgeAdj.prev;
        let hedgeAdjNext: HalfEdge = hedgeAdj.next;
        let hedgeOppPrev: HalfEdge = hedgeOpp.prev;
        let hedgeOppNext: HalfEdge = hedgeOpp.next;
        let foo: number = 0;
    ...
    public triangulate(newFaces: java.util.List<Face>) {
        ...
        const v0: Vertex = this.he0.head();
        hedge = this.he0.next;
        let oppPrev: HalfEdge = hedge.opposite;
        let face0: Face = null;
