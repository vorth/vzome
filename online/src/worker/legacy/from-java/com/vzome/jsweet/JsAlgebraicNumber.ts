...
import { JsAlgebraicField } from "./JsAlgebraicField.js";

export class JsAlgebraicNumber implements AlgebraicNumber {
    /*private*/ field: JsAlgebraicField;

    /*private*/ factors: number[];

    public constructor(field: JsAlgebraicField, factors: number[]) {
     ...
     * @return {*} this + n
     */
    public plusInt(n: number): AlgebraicNumber {
     ...
     * @return {*}
     */
    public timesInt(n: number): AlgebraicNumber {
        switch((n)) {
        case 0:
     ...
     * @return {*} this + (num / den)
     */
    public plusRational(num: number, den: number): AlgebraicNumber {
        return this.plus$com_vzome_core_algebra_AlgebraicNumber(this.field.createRational$long$long(num, den));
    }

    public plus$com_vzome_core_algebra_AlgebraicNumber(that: AlgebraicNumber): AlgebraicNumber {
     ...
     * @return {*}
     */
    public minusInt(n: number): AlgebraicNumber {
     ...
     * @return {*}
     */
    public minusRational(num: number, den: number): AlgebraicNumber {
        return this.minus$com_vzome_core_algebra_AlgebraicNumber(this.field.createRational$long$long(num, den));
    }

    public minus$com_vzome_core_algebra_AlgebraicNumber(that: AlgebraicNumber): AlgebraicNumber {
    ...
    public times$com_vzome_core_algebra_AlgebraicNumber(that: AlgebraicNumber): AlgebraicNumber {
     ...
     * @return {*}
     */
    public dividedByInt(divisor: number): AlgebraicNumber {
     ...
     * @return {*}
     */
    public dividedByRational(num: number, den: number): AlgebraicNumber {
     ...
     * @return {*}
     */
    public dividedBy(that: AlgebraicNumber): AlgebraicNumber {
    ...
    public equals(that: AlgebraicNumber): boolean {
     ...
     * @return {*}
     */
    public reciprocal(): AlgebraicNumber {
        return new JsAlgebraicNumber(this.field, (<JsAlgebraicField>this.field).reciprocal(this.factors));
    }
     ...
     * @return {number}
     */
    public compareTo(other: AlgebraicNumber): number {
        if (this === other){
            return 0;
        }
     ...
     * @return {boolean}
     */
    public greaterThan(other: AlgebraicNumber): boolean {
     ...
     * @return {boolean}
     */
    public lessThan(other: AlgebraicNumber): boolean {
        return this.compareTo(other) < 0;
    }
     ...
     * @return {boolean}
     */
    public greaterThanOrEqualTo(other: AlgebraicNumber): boolean {
        return this.compareTo(other) >= 0;
    }
     ...
     * @return {boolean}
     */
    public lessThanOrEqualTo(other: AlgebraicNumber): boolean {
        return this.compareTo(other) <= 0;
    }
     ...
     * @return {*}
     */
    public timesRational(num: number, den: number): AlgebraicNumber {
