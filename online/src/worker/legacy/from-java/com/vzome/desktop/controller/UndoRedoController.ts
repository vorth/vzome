...
import { EditHistory } from "../../core/editor/EditHistory.js";
import { DefaultController } from "./DefaultController.js";

export class UndoRedoController extends DefaultController {
    /*private*/ model: EditHistory;

    public constructor(model: EditHistory) {
        super();
