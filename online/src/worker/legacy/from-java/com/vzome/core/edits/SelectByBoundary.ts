...
export abstract class SelectByBoundary extends ChangeManifestations {
    ...
    public boundaryContains$com_vzome_core_model_Connector(connector: Connector): boolean {
    ...
    public boundaryContains(connector?: any): boolean {
        ...
        } else if (((connector != null && connector instanceof <any>AlgebraicVector) || connector === null)) {
            return <any>this.boundaryContains$com_vzome_core_algebra_AlgebraicVector(connector);
        } else throw new Error('invalid overload');
    }

    /*private*/ boundaryContains$com_vzome_core_model_Strut(strut: Strut): boolean {
    ...
    /*private*/ boundaryContains$com_vzome_core_model_Panel(panel: Panel): boolean {
    ...
    boundaryContains$com_vzome_core_algebra_AlgebraicVector(v: AlgebraicVector): boolean { throw new Error('cannot invoke abstract overloaded method... check your argument(s) type(s)'); }
}
