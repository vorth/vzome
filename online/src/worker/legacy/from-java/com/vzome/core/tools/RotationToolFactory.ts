...
import { RotationTool } from "./RotationTool.js";

export class RotationToolFactory extends AbstractToolFactory {
    ...
    public constructor(tools?: any, symmetry?: any, id?: any, label?: any, tooltip?: any) {
        if (((tools != null && tools instanceof <any>ToolsModel) || tools === null) && ((symmetry != null && (symmetry.constructor != null && symmetry.constructor["__interfaces"] != null && symmetry.constructor["__interfaces"].indexOf("com.vzome.core.math.symmetry.Symmetry") >= 0)) || symmetry === null) && ((typeof id === 'string') || id === null) && ((typeof label === 'string') || label === null) && ((typeof tooltip === 'string') || tooltip === null)) {
            let __args = arguments;
            super(tools, symmetry, id, label, tooltip);
            if (this.noStrut === undefined) { this.noStrut = false; } 
        } else if (((tools != null && tools instanceof <any>ToolsModel) || tools === null) && ((symmetry != null && (symmetry.constructor != null && symmetry.constructor["__interfaces"] != null && symmetry.constructor["__interfaces"].indexOf("com.vzome.core.math.symmetry.Symmetry") >= 0)) || symmetry === null) && ((typeof id === 'boolean') || id === null) && label === undefined && tooltip === undefined) {
            let __args = arguments;
        ...
        } else if (((tools != null && tools instanceof <any>ToolsModel) || tools === null) && ((symmetry != null && (symmetry.constructor != null && symmetry.constructor["__interfaces"] != null && symmetry.constructor["__interfaces"].indexOf("com.vzome.core.math.symmetry.Symmetry") >= 0)) || symmetry === null) && id === undefined && label === undefined && tooltip === undefined) {
            let __args = arguments;
            {
                let __args = arguments;
    ...
    public createToolInternal(id: string): Tool {
        return new RotationTool(id, this.getSymmetry(), this.getToolsModel(), false);
    }
    ...
    bindParameters(selection: Selection): boolean {
        ...
        for(let index=selection.iterator();index.hasNext();) {
            ...
            if (man != null && (man.constructor != null && man.constructor["__interfaces"] != null && man.constructor["__interfaces"].indexOf("com.vzome.core.model.Strut") >= 0)){
                ...
                const perm: Permutation = axis.getRotationPermutation();
                if (perm == null)return false;
            } else if (this.noStrut){
                const axis: Axis = symmetry.getPreferredAxis();
                if (axis == null)return false;
            }
        }
        return true;
