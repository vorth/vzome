 ...
 * @class
 * @extends RotationToolFactory
 */
export class AxialSymmetryToolFactory extends RotationToolFactory {
    ...
    public constructor(tools: ToolsModel, symmetry: Symmetry, useSymmetryName: boolean = false) {
    ...
    public createToolInternal(id: string): Tool {
        return new RotationTool(id, this.getSymmetry(), this.getToolsModel(), true);
    }
}
