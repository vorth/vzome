import { LineReflection } from "../construction/LineReflection.js";
...
export class LineReflectionTool extends TransformationTool {
    ...
    checkSelection(prepareTool: boolean): string {
        ...
        if (prepareTool){
            ...
            this.transforms[0] = new LineReflection(axis);
        }
        return null;
    }
