...
export class SelectByDiameter extends SelectByBoundary {
    ...
    center: AlgebraicVector;

    maxRadiusSquared: AlgebraicNumber;
    ...
    adjustBoundary(vectors: java.util.List<AlgebraicVector>): string {
        ...
        case 1:
            return null;
        case 2:
            this.center = AlgebraicVectors.calculateCentroid(vectors);
            const v1: AlgebraicVector = vectors.get(0).minus(this.center);
    ...
    setBoundary(): string {
        ...
        const vectors: java.util.List<AlgebraicVector> = <any>(new java.util.ArrayList<any>());
    ...
    public boundaryContains$com_vzome_core_algebra_AlgebraicVector(v: AlgebraicVector): boolean {
        ...
        const vSq: AlgebraicNumber = v.dot(v);
