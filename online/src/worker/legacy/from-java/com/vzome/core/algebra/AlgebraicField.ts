...
export interface AlgebraicField {
    ...
    nearestAlgebraicVector(target: RealVector): AlgebraicVector;

    getName(): string;

    createAlgebraicNumber(ones?: any, irrat?: any, denominator?: any, scalePower?: any): AlgebraicNumber;
     ...
     */
    getGoldenRatio(): AlgebraicNumber;

    createPower(power?: any, irr?: any): AlgebraicNumber;
     ...
     */
    createRational(numerator?: any, denominator?: any): AlgebraicNumber;
     ...
     */
    getUnitTerm(n: number): AlgebraicNumber;
     ...
     */
    projectTo3d(source: AlgebraicVector, wFirst: boolean): AlgebraicVector;

    origin(dims: number): AlgebraicVector;

    basisVector(dims: number, axis: number): AlgebraicVector;

    zero(): AlgebraicNumber;
     ...
     */
    createVector(nums: number[][]): AlgebraicVector;
     ...
     * @return {AlgebraicVector} an AlgebraicVector
     */
    createIntegerVector(nums: number[][]): AlgebraicVector;
     ...
     */
    createMatrix(data: number[][][]): AlgebraicMatrix;

    parseLegacyNumber(val: string): AlgebraicNumber;

    parseNumber(nums: string): AlgebraicNumber;

    parseVector(nums: string): AlgebraicVector;

    identityMatrix(dims: number): AlgebraicMatrix;
    ...
    parseVefNumber(string: string, isRational: boolean): AlgebraicNumber;
     ...
     */
    getNumberByName(name: string): AlgebraicNumber;

    supportsSubfield(fieldName: string): boolean;

    interpretScript(script: string, language: string, offset: Point, symmetry: Symmetry, effects: ConstructionChanges);
}
...
export namespace AlgebraicField {
    ...
    export interface Registry {
        getField(name: string): AlgebraicField;
    }
}
