...
export class Bivector3d {
    /*private*/ a: AlgebraicNumber;

    /*private*/ b: AlgebraicNumber;

    /*private*/ c: AlgebraicNumber;

    public constructor(a: AlgebraicNumber, b: AlgebraicNumber, c: AlgebraicNumber) {
     ...
     * @return {*}
     */
    public outer(v: Vector3d): AlgebraicNumber {
        const a: AlgebraicNumber = this.a['times$com_vzome_core_algebra_AlgebraicNumber'](v.c);
        const b: AlgebraicNumber = this.b['times$com_vzome_core_algebra_AlgebraicNumber'](v.a);
        const c: AlgebraicNumber = this.c['times$com_vzome_core_algebra_AlgebraicNumber'](v.b);
