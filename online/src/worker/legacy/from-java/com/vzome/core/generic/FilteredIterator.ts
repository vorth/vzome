...
export namespace FilteredIterator {
    ...
    export class Filters {
        ...
        public static not<B>(predicate: (p1: B) => boolean, arg: B): boolean {
            return (target => (typeof target === 'function') ? target(arg) : (<any>target).test(arg))((target => (typeof target === 'function') ? (<any>target)() : (<any>target).negate())(predicate));
        }
        ...
        public static and<B>(check1: (p1: B) => boolean, check2: (p1: B) => boolean, arg: B): boolean {
            return (target => (typeof target === 'function') ? target(arg) : (<any>target).test(arg))((target => (typeof target === 'function') ? (<any>target)(check2) : (<any>target).and(check2))(check1));
        }
        ...
        public static or<B>(check1: (p1: B) => boolean, check2: (p1: B) => boolean, arg: B): boolean {
            return (target => (typeof target === 'function') ? target(arg) : (<any>target).test(arg))((target => (typeof target === 'function') ? (<any>target)(check2) : (<any>target).or(check2))(check1));
        }
    }
