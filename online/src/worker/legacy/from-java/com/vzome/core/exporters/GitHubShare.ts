...
export class GitHubShare {
    ...
    public generateContent(orgName: string, repoName: string, branchName: string, title: string, description: string, blog: boolean, publish: boolean, style: string): string {
        ...
        const viewerTemplate: string = ResourceLoader.loadStringResource("com/vzome/core/exporters/github/viewerTemplate.md");
        const instructionsTemplate: string = ResourceLoader.loadStringResource("com/vzome/core/exporters/github/instructionsTemplate.md");
        ...
        const indexTemplate: string = ResourceLoader.loadStringResource("com/vzome/core/exporters/github/indexTemplate.md");
        ...
        const readmeTemplate: string = ResourceLoader.loadStringResource("com/vzome/core/exporters/github/readmeTemplate.md");
        ...
        if (blog){
            const githubReadmeBlogPrefixTemplate: string = ResourceLoader.loadStringResource("com/vzome/core/exporters/github/readmeBlogPrefixTemplate.md");
            ...
            const postTemplate: string = ResourceLoader.loadStringResource("com/vzome/core/exporters/github/postTemplate.md");
