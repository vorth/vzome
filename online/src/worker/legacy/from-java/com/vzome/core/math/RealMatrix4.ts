...
export class RealMatrix4 {
    ...
    /**
     * 
     * @param {RealVector} v 4th component treated as 1
     * @return
     * @return {RealVector}
     */
    public transform3dPt(v: RealVector): RealVector {
        return new RealVector((<any>Math).fround((<any>Math).fround((<any>Math).fround((<any>Math).fround(this.m00 * v.x) + (<any>Math).fround(this.m01 * v.y)) + (<any>Math).fround(this.m02 * v.z)) + this.m03), (<any>Math).fround((<any>Math).fround((<any>Math).fround((<any>Math).fround(this.m10 * v.x) + (<any>Math).fround(this.m11 * v.y)) + (<any>Math).fround(this.m12 * v.z)) + this.m13), (<any>Math).fround((<any>Math).fround((<any>Math).fround((<any>Math).fround(this.m20 * v.x) + (<any>Math).fround(this.m21 * v.y)) + (<any>Math).fround(this.m22 * v.z)) + this.m23));
    }

    /**
     * 
     * @param {RealVector} v 4th component treated as 0
     * @return
     * @return {RealVector}
     */
    public transform3dVec(v: RealVector): RealVector {
        return new RealVector((<any>Math).fround((<any>Math).fround((<any>Math).fround(this.m00 * v.x) + (<any>Math).fround(this.m01 * v.y)) + (<any>Math).fround(this.m02 * v.z)), (<any>Math).fround((<any>Math).fround((<any>Math).fround(this.m10 * v.x) + (<any>Math).fround(this.m11 * v.y)) + (<any>Math).fround(this.m12 * v.z)), (<any>Math).fround((<any>Math).fround((<any>Math).fround(this.m20 * v.x) + (<any>Math).fround(this.m21 * v.y)) + (<any>Math).fround(this.m22 * v.z)));
    }
     ...
     * @param {RealVector} eye the location of the eye
     * @param {RealVector} center a point in the virtual world where the eye is looking
     * @param {RealVector} up an up vector specifying the frustum's up direction
     * @return {RealMatrix4}
     */
    public static lookAt(eye: RealVector, center: RealVector, up: RealVector): RealMatrix4 {
        let forwardx: number;
        let forwardy: number;
        let forwardz: number;
        let invMag: number;
