...
export class OpenScadMeshExporter extends GeometryExporter {
    ...
    static FORMAT: NumberFormat; public static FORMAT_$LI$(): NumberFormat { OpenScadMeshExporter.__static_initialize(); if (OpenScadMeshExporter.FORMAT == null) { OpenScadMeshExporter.FORMAT = NumberFormat.getNumberInstance(java.util.Locale.US); }  return OpenScadMeshExporter.FORMAT; }
...
OpenScadMeshExporter.__static_initialize();
