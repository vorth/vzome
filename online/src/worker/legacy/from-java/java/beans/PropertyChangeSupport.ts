...
import { ChangeListenerMap } from "./ChangeListenerMap.js";
import { IndexedPropertyChangeEvent } from "./IndexedPropertyChangeEvent.js";
import { PropertyChangeEvent } from "./PropertyChangeEvent.js";
import { PropertyChangeListener } from "./PropertyChangeListener.js";
import { PropertyChangeListenerProxy } from "./PropertyChangeListenerProxy.js";
...
export class PropertyChangeSupport {
    ...
    public addPropertyChangeListener$java_beans_PropertyChangeListener(listener: PropertyChangeListener) {
        if (listener == null){
            return;
        }
        if (listener != null && listener instanceof <any>PropertyChangeListenerProxy){
            const proxy: PropertyChangeListenerProxy = <PropertyChangeListenerProxy><any>listener;
    ...
    public removePropertyChangeListener$java_beans_PropertyChangeListener(listener: PropertyChangeListener) {
        if (listener == null){
            return;
        }
        if (listener != null && listener instanceof <any>PropertyChangeListenerProxy){
    ...
    public addPropertyChangeListener$java_lang_String$java_beans_PropertyChangeListener(propertyName: string, listener: PropertyChangeListener) {
    ...
    public removePropertyChangeListener$java_lang_String$java_beans_PropertyChangeListener(propertyName: string, listener: PropertyChangeListener) {
        if (listener == null || propertyName == null){
            return;
        }
        listener = this.map.extract$java_beans_PropertyChangeListener(listener);
    ...
    public getPropertyChangeListeners$java_lang_String(propertyName: string): PropertyChangeListener[] {
        return this.map.getListeners$java_lang_String(propertyName);
    }

    public getPropertyChangeListeners(propertyName?: any): PropertyChangeListener[] {
    ...
    public firePropertyChange$java_lang_String$java_lang_Object$java_lang_Object(propertyName: string, oldValue: any, newValue: any) {
        if (oldValue == null || newValue == null || !/* equals */(<any>((o1: any, o2: any) => o1 && o1.equals ? o1.equals(o2) : o1 === o2)(oldValue,newValue))){
            this.firePropertyChange$java_beans_PropertyChangeEvent(new PropertyChangeEvent(this.source, propertyName, oldValue, newValue));
        }
    }
    ...
    public firePropertyChange(propertyName?: any, oldValue?: any, newValue?: any) {
        ...
        } else if (((propertyName != null && propertyName instanceof <any>PropertyChangeEvent) || propertyName === null) && oldValue === undefined && newValue === undefined) {
    ...
    public firePropertyChange$java_beans_PropertyChangeEvent(event: PropertyChangeEvent) {
        const oldValue: any = event.getOldValue();
        const newValue: any = event.getNewValue();
        if (oldValue == null || newValue == null || !/* equals */(<any>((o1: any, o2: any) => o1 && o1.equals ? o1.equals(o2) : o1 === o2)(oldValue,newValue))){
            const name: string = event.getPropertyName();
            const common: PropertyChangeListener[] = this.map.get(null);
            const named: PropertyChangeListener[] = (name != null) ? this.map.get(name) : null;
            PropertyChangeSupport.fire(common, event);
            PropertyChangeSupport.fire(named, event);
        }
    }

    static fire(listeners: PropertyChangeListener[], event: PropertyChangeEvent) {
        if (listeners != null){
    ...
    public fireIndexedPropertyChange$java_lang_String$int$java_lang_Object$java_lang_Object(propertyName: string, index: number, oldValue: any, newValue: any) {
        if (oldValue == null || newValue == null || !/* equals */(<any>((o1: any, o2: any) => o1 && o1.equals ? o1.equals(o2) : o1 === o2)(oldValue,newValue))){
            this.firePropertyChange$java_beans_PropertyChangeEvent(new IndexedPropertyChangeEvent(this.source, propertyName, oldValue, newValue, index));
        }
    }
...
export namespace PropertyChangeSupport {
    ...
    export class PropertyChangeListenerMap extends ChangeListenerMap<PropertyChangeListener> {
        static EMPTY: PropertyChangeListener[]; public static EMPTY_$LI$(): PropertyChangeListener[] { if (PropertyChangeListenerMap.EMPTY == null) { PropertyChangeListenerMap.EMPTY = []; }  return PropertyChangeListenerMap.EMPTY; }
         ...
         */
        newArray(length: number): PropertyChangeListener[] {
            return (0 < length) ? (s => { let a=[]; while(s-->0) a.push(null); return a; })(length) : PropertyChangeListenerMap.EMPTY_$LI$();
        }

        public newProxy$java_lang_String$java_beans_PropertyChangeListener(name: string, listener: PropertyChangeListener): PropertyChangeListener {
        ...
        public extract$java_beans_PropertyChangeListener(listener: PropertyChangeListener): PropertyChangeListener {
            while((listener != null && listener instanceof <any>PropertyChangeListenerProxy)) {{
                listener = (<PropertyChangeListenerProxy><any>listener).getListener();
            }};
            return listener;
        }
